...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Altas a la seguridad social: ");
        seguridadSocial.obtenerTodas();


        System.out.println("Baja a la seguridad social: ");
        seguridadSocial.bajaPersona(anna.getDni());


        System.out.println("Lista de afiliados a la S.S.: ");
        seguridadSocial.obtenerTodas();

        System.out.println("obtenerPersonaPorDNI: ");
        seguridadSocial.obtenerPersonaPorDNI(jose.getDni());
        ...
        System.out.println("obtenerPersonasMayoresQue: ");
        seguridadSocial.obtenerPersonasMayoresQue(25);
